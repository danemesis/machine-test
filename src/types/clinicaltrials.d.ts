...
export interface components {
  schemas: {
    FieldNode: {
      ...
      dedLink?: components['schemas']['WebLink'];
      description?: string;
    ...
    ModelPredictions: Record<string, never>;
    BmiLimits: Record<string, never>;
    EnrollmentInfo: {
      count?: number;
    ...
    FieldValuesStats:
      | components['schemas']['EnumStats']
      | components['schemas']['StringStats']
      | components['schemas']['DateStats']
      | components['schemas']['IntegerStats']
      | components['schemas']['NumberStats']
      | components['schemas']['BooleanStats'];
    /**
     * Array of studies
